...
public class BinaryGapTask {
     ...
     * 
     * N is an integer within the range [1..2,147,483,647]. Copyright 2009–2020 by
    ...
    public static int solution(int N) {
        ...
        return Arrays.stream(nAsBinary.substring(0, nAsBinary.lastIndexOf('1') + 1).split("1")).mapToInt(String::length)
                .max().getAsInt();
    }
